...
AwdReader::AwdReader(FbxManager &pManager, int pID):
...
void AwdReader::GetVersion(int& pMajor, int& pMinor, int& pRevision)
...
bool AwdReader::FileOpen(char* pFileName)
{
...
bool AwdReader::GetReadOptions(bool /*pParseFileAsNeeded*/)
{
    return true;
}

//Read the custom file and reconstruct node hierarchy.
bool AwdReader::Read(FbxDocument* pDocument)
{
    if (!pDocument)
    {
